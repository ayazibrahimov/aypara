            ...
            <div class="container nav-container">
                ...
                <div class="collapse navbar-collapse" id="miralax_main_menu">
                   ...
                   <!-- class="menu-item-has-children current-menu-item" -->
                        ...
                        <li><a href="blog.php">İqtisadiyyat</a></li>
                        <li><a href="blog-category.html">Siyasət</a></li>
                        <li><a href="blog-category.html">Cəmiyyət</a></li>
                        ...
                        <li><a href="about.html">Hadisə</a></li>
                        <li><a href="contact.html">İdman</a></li>
                        <li><a href="contact.html">Sağlamlıq</a></li>
                    </ul>
                </div>
                ...
                <div class="item">
                    <div class="top-post-wrap mb-0">
                        ...
                        <div class="top-post-details">
                            <a class="tag top-right tag-pest" href="#">Təbiət</a>
                            <h2><a href="blog-category.html">Dağlar qoynunda yerləşən, "Rus Parisi" kimi tanınan Azərbaycan kəndi </a></h2>
                            <div class="meta mt-2">
                                <div class="user">
                                    <div class="thumb">
                                        <img src="assets/img/imagedata/avatar.jpg" alt="img">
                                    </div>
                                    <a href="#">Samir Kərimov</a>
                                </div>
                                <div class="date">
                ...
                <div class="item">
                    <div class="top-post-wrap mb-0">
                        ...
                        <div class="top-post-details">
                            ...
                            <h2><a href="blog-category.html">Rəqəmsal marketing haqqında məqalələr.Azərbaycanda rəqəmsal marketing sferası və onun inkişafı.</a></h2>
                            <div class="meta mt-2">
                                <div class="user">
                                    <div class="thumb">
                                        <img src="assets/img/imagedata/avatar2.jpg" alt="img">
                                    </div>
                                    <a href="#">İlahə Ağayeva</a>
                                </div>
                                <div class="date">
                                    <i class="fa fa-clock-o"></i>
						                Mar 16, 2022						
                    ...
                    <div class="row">
                            <div class="col-lg-6">
                                <div class="top-post-wrap">
                                    <div class="thumb">
                                        <img src="assets/img/imagedata/news-image.png" alt="img" style="opacity: 1;">
                            ...
                            <div class="col-lg-6">
                                <div class="top-post-wrap">
                                    <div class="thumb">
                                        <img src="assets/img/imagedata/news-image-2.jpg" alt="img" style="opacity: 1;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h4 class="title left-line">Din</h4>
                    </div>
                </div>
    ...
    <div class="top-news-area pd-top-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title pb-0">
                        <h4 class="title left-line">Elm və texnologiya</h4>
                    </div>
                    ...
                    <div class="section-title pb-0 pd-top-80">
                        <h4 class="title left-line">Verlişlər</h4>
                    </div>
    ...
    <div class="pd-top-70 pd-bottom-30">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h4 class="title left-line">Foto</h4>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="media-post-wrap">

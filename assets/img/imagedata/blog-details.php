    ...
    <div class="navbar-area">
        <nav class="navbar navbar-expand-lg">
            <div class="container nav-container">
                <a class="main-logo" href="index.php"><img src="assets/img/imagedata/logoimage.png" alt="img"></a>
                ...
                <div class="collapse navbar-collapse" id="miralax_main_menu">
                   ...
                   <!-- class="menu-item-has-children current-menu-item" -->
                        ...
                        <!-- <li class="menu-item-has-children current-menu-item">
                            <a href="#">Features</a>
                            <ul class="sub-menu">
                                <li><a href="blog.html">Hadisə</a></li>
                                <li><a href="blog-category.html">İdman</a></li>
                                <li><a href="blog-details.html">Post Layout</a></li>
                            </ul>
                        </li> -->
                        <li><a href="blog-category.php">Hadisə</a></li>
                        <li><a href="blog-category.php">İdman</a></li>
                        <li><a href="blog-category.php">Sağlamlıq</a></li>
                    </ul>
                </div>
    ...
    <div class="container">
        <div class="breadcrumb-area">
            <div class="row justify-content-center">
                <div class="col-md-12">
					<h1 class="theme-breacrumb-title">Xəbər başlığı </h1>
				</div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="media-post-wrap mb-0">
                        <div class="detail__image--1 mb-4">
                            <img src="assets/img/imagedata/news-image-2.jpg" alt="img">
                        </div>
                        <div class="media-body pt-1 ms-0">
                            <a class="tag top-right tag-pest tag__change-padding-left">Business</a>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                <div class="detail__image--2 detail__image-major-2">
                                    <img src="assets/img/imagedata/news-image.png" alt="">
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="detail__image--2 detail__image-major-2">
                                    <img src="assets/img/imagedata/news-image-2.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="detail__image--3 mt-4">
                            <img src="assets/img/imagedata/culture-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="widget widget_search">
                            ...
                            <div class="subscribe-inner single-input-wrap">
                                <input type="text" placeholder='Axtar...' class="form-control">
                                <button class="btn">Axtar</button>
                             </div>
                        </div>
                    ...
                    <div class="section-title pb-0">
                        <h4 class="title left-line">Xəbər Lenti</h4>
                    </div>
                    <div class='culture__scroll'>
                     
                     <div class="media-post-wrap-3 media">
                       <div class="detail__image--4---image">
                          <a href="blog-details.php"><img src="assets/img/imagedata/featuredImage--2.jpg" alt="img"></a>
                       </div>
                       <div class="detail__image--4---text">
                       <a href="blog-details.php"><span class='detail__image--4---text__tittle'>Ailəsi ilə Ümrəyə gedən İstanbul Böyük Şəhər Bələdiyyəsinin sədri Əkrəm İmamoğlunun ilk fotosu</span></a>
                          <div class="meta d-flex">
                               <div class="tag detail__image--4---text___tag"><a >Politics</a></div>
                               <div class="date">
                     ...
                     <div class="media-post-wrap-3 media">
                       ...
                       <div class="detail__image--4---text">
                          <a href="blog-details.php"><span class='detail__image--4---text__tittle'>İlon Mask Twitter-i aldıqdan sonra işçilərin təxminən 80%-i şirkəti tərk etdi</span></a>
                          <div class="meta d-flex">
                               <div class="tag detail__image--4---text___tag"><a >Politics</a></div>
                               <div class="date">
                                   <i class="fa fa-clock-o"></i>
                     ...
                     <div class="media-post-wrap-3 media">
                       ...
                       <div class="detail__image--4---text">
                          ...
                          <a href="blog-details.php"><span class='detail__image--4---text__tittle'>ATAK helikopterinin üst versiyası olan Atak-ll bu il ilk uçuşunu edəcək</span></a>
                          <div class="meta d-flex">
                               <div class="tag detail__image--4---text___tag"><a >Politics</a></div>
                               <div class="date">
                                   <i class="fa fa-clock-o"></i>
                     ...
                     <div class="media-post-wrap-3 media">
                       <div class="detail__image--4---image">
                          <a href="blog-details.php"><img src="assets/img/imagedata/featuredImage--6.jpg" alt="img"></a>
                       </div>
                       <div class="detail__image--4---text">
                          <a href="blog-details.php"><span class='detail__image--4---text__tittle'>Bakı polisi: Binaların eyvanında paltarqurutma ənənəsinə son qoyulmalıdır</span></a>
                          <div class="meta d-flex">
                               <div class="tag detail__image--4---text___tag"><a >Politics</a></div>
                               <div class="date">
                                   <i class="fa fa-clock-o"></i>
                     ...
                     <div class="widget widget_tags mt-5">
                        <div class="section-title pb-0">
                            <h4 class="title left-line widget-title">Etiketlər</h4>
                        </div>
                        <div class="tagcloud">
                            <a href="blog.php">Biznes</a>
                            <a href="blog.php">İqtisadiyyat</a>
                            <a href="blog.php">Mədəniyyət</a>
                            <a href="blog.php">Siyasət</a>
                            <a href="blog.php">İdman</a>
                            <a href="blog.php">Sağlamlıq</a>
                            <a href="blog.php">Səhiyə</a>
                            <a href="allvideoes.php">Video Xəbərlər</a>
                        </div>
                    </div>                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="widget widget_about">
                            <div class="logo">
                                <a href="index.php"><img src="assets/img/imagedata/logo_footer.png" alt=""></a>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <h5 class="widget-title">Link 13</h5>
                        <div class="widget widget_link">
                            <ul>
                                <li><a href="blog.php">Foto
                                </a></li>
                                <li><a href="allvideoes.php">Video Xəbərlər
                                </a></li>

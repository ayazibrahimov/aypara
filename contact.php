    ...
    <div class="container">
        <div class="breadcrumb-area">
            <div class="row justify-content-center">
                <div class="col-md-12">
					<h1 class="theme-breacrumb-title">Bizimlə Əlaqə</h1>
				</div>
            </div>
        </div>
    </div>
    ...
    <div class="about-area pd-top-100 pd-bottom-80">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="media-post-wrap contact__box mb-0">
                        <!-- <div class="thumb mb-5">
                            <img class="w-100" src="assets/img/blog/contact.jpg" alt="img">
                        </div> -->
                        <h4>
                            Bizimlə necə əlaqəyə keçə bilərsiz
                        </h4>
                        ...
                        <h4 class="mt-5">Mesaj göndərin</h4>
                        <!-- <p>Your email address will not be published. All the fields are required.</p> -->
                        <form class="comment-form mt-5">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div>
                                       <label class="mb-3">Adınız:</label>
                                       <div class="single-input-wrap">
                                          <input type="text" placeholder='Ad' class="form-control">
                                       </div>
                                    </div>
                                    <div>
                                       <label class="mb-3">E-Poçt ünvanınız:</label>
                                       <div class="single-input-wrap">
                                          <input type="email" placeholder='E-poçt' class="form-control">
                                       </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                     <div>
                                     <label class="mb-3">Mesajınız:</label>
                            ...
                            <button type="submit" class="btn btn-main">Göndər</button>
                        </form>
                    </div>
                </div>
                <!-- <div class="col-lg-4">

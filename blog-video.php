    ...
    <div class="container">
        <div class="breadcrumb-area">
            <div class="row justify-content-center">
                <div class="col-md-12">
					<h1 class="theme-breacrumb-title">National Geographic "The Story of God" (Alllahın hekayəsi) sənədli filmin treylerini yayımlayıb - VİDEO</h1>
				</div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="media-post-wrap mb-0">
                        ...
                        <iframe class='video__control' width="560" height="315" src="https://www.youtube.com/embed/d2Fl9UcJkBA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                        <div class="media-body pt-1 ms-0">
                            <a class="tag top-right tag-pest tag__change-padding-left">Business</a>
                            <h1>National Geographic Dinlər mövzusunda çəkdiyi sənədli film çox böyük marağa səbəb olmuşdu. </h1>
                        </div>
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-6 col-12">
                                <div class="detail__image--2 detail__image-major-2">
                                    <img src="assets/img/imagedata/news-freeman.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="detail__image--2 detail__image-major-2">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="section-title pb-0">
                        <h4 class="title left-line">Oxşar Xəbərlər</h4>
                    </div>
                     <div class='culture__scroll'>
                     
                      <div class="media-post-wrap-3 media">
                        <div class="detail__image--4---image video__image--box">
                            <a href="blog-video.php">
                                <img class="image__control" src="assets/img/imagedata/news-freeman.jpg" alt="img">
                                <div class="video__image--btn">
                                  <img style="width:75%;" src="assets/img/icon/play.png" alt="img">
                                </div>
                            </a>
                        </div>
                        <div class="detail__image--4---text">
                           <h6><a href="blog-video.php">Sənədli film çox böyük marağa səbəb olmuşdur</a></h6>
                           <div class="meta d-flex">
                                <div class="tag detail__image--4---text___tag"><a>Din</a></div>
                                <div class="date">
